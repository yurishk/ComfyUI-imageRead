...
- **Folder**: browse only the current directory or include subdirectories, open parent/child folders directly, search relative paths, and view 48 images at a time without uploading the folder.
